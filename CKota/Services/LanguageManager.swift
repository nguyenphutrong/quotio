...
final class LanguageManager {
    ...
    func localized(_ key: String) -> String {
        LocalizedStrings.get(key, language: currentLanguage)
    }
}
...
enum LocalizedStrings {
    private static let strings: [String: [AppLanguage: String]] = [
        ...
        "nav.home": [.english: "Home", .vietnamese: "Trang chủ"],
        "nav.quota": [.english: "Quota", .vietnamese: "Hạn mức"],
        "nav.analytics": [.english: "Analytics", .vietnamese: "Phân tích"],
        ...
        "dashboard.clickToInstall": [
            .english: "Click the button below to automatically download and install",
            .vietnamese: "Nhấn nút bên dưới để tự động tải và cài đặt",
        ],
        "dashboard.installCLI": [.english: "Install CLIProxyAPI", .vietnamese: "Cài đặt CLIProxyAPI"],
        "dashboard.startToBegin": [
            .english: "Start the proxy server to begin",
            .vietnamese: "Khởi động máy chủ proxy để bắt đầu",
        ],
        ...
        "quota.tokenExpired": [
            .english: "Token expired - please re-authenticate",
            .vietnamese: "Token hết hạn - vui lòng xác thực lại",
        ],
        ...
        "providers.noAccountsYet": [
            .english: "No accounts connected yet",
            .vietnamese: "Chưa có tài khoản nào được kết nối",
        ],
        "providers.startProxyFirst": [
            .english: "Start the proxy first to manage providers",
            .vietnamese: "Khởi động proxy trước để quản lý nhà cung cấp",
        ],
        ...
        "providers.deleteAccount": [.english: "Delete Account", .vietnamese: "Xóa tài khoản"],
        "providers.deleteAccountMessage": [
            .english: "This will remove the local auth file for this account. You can re-authenticate later.",
            .vietnamese: "Thao tác này sẽ xóa file xác thực cục bộ của tài khoản này. Bạn có thể xác thực lại sau.",
        ],
        ...
        "settings.autoStartProxy": [
            .english: "Auto-start proxy on launch",
            .vietnamese: "Tự khởi động proxy khi mở app",
        ],
        "settings.restartProxy": [
            .english: "Restart proxy after changing port",
            .vietnamese: "Khởi động lại proxy sau khi đổi cổng",
        ],
        ...
        "settings.roundRobinDesc": [
            .english: "Distributes requests evenly across all accounts",
            .vietnamese: "Phân phối yêu cầu đều cho tất cả tài khoản",
        ],
        "settings.fillFirstDesc": [
            .english: "Uses one account until quota exhausted, then moves to next",
            .vietnamese: "Dùng một tài khoản đến khi hết hạn mức, rồi chuyển sang tài khoản tiếp",
        ],
        "settings.quotaExceededBehavior": [
            .english: "Quota Exceeded Behavior",
            .vietnamese: "Hành vi khi vượt hạn mức",
        ],
        "settings.autoSwitchAccount": [
            .english: "Auto-switch to another account",
            .vietnamese: "Tự động chuyển sang tài khoản khác",
        ],
        "settings.autoSwitchPreview": [
            .english: "Auto-switch to preview model",
            .vietnamese: "Tự động chuyển sang mô hình xem trước",
        ],
        "settings.quotaExceededHelp": [
            .english: "When quota is exceeded, automatically try alternative accounts or models",
            .vietnamese: "Khi vượt hạn mức, tự động thử tài khoản hoặc mô hình khác",
        ],
        ...
        "settings.retryHelp": [
            .english: "Number of times to retry failed requests (403, 408, 500, 502, 503, 504)",
            .vietnamese: "Số lần thử lại yêu cầu thất bại (403, 408, 500, 502, 503, 504)",
        ],
        ...
        "settings.loggingHelp": [
            .english: "Write application logs to rotating files instead of stdout. Disable to log to stdout/stderr.",
            .vietnamese: "Ghi nhật ký vào file xoay vòng thay vì stdout. Tắt để ghi ra stdout/stderr.",
        ],
        ...
        "settings.restartForEffect": [
            .english: "Restart app for full effect",
            .vietnamese: "Khởi động lại ứng dụng để có hiệu lực đầy đủ",
        ],
        "settings.apiKeys": [.english: "API Keys", .vietnamese: "Khóa API"],
        "settings.apiKeysHelp": [
            .english: "API keys for clients to authenticate with the proxy",
            .vietnamese: "Khóa API để các client xác thực với proxy",
        ],
        ...
        "apiKeys.description": [
            .english: "API keys for clients to authenticate with the proxy service",
            .vietnamese: "Khóa API để các client xác thực với dịch vụ proxy",
        ],
        ...
        "apiKeys.emptyDescription": [
            .english: "Add API keys to authenticate clients with the proxy",
            .vietnamese: "Thêm khóa API để xác thực client với proxy",
        ],
        ...
        "logs.logsWillAppear": [
            .english: "Logs will appear here as requests are processed",
            .vietnamese: "Nhật ký sẽ xuất hiện khi có yêu cầu được xử lý",
        ],
        ...
        "logs.showingRecent": [
            .english: "Showing the last 20 log entries. Clear logs to reset.",
            .vietnamese: "Hiển thị 20 mục nhật ký gần nhất. Xóa nhật ký để đặt lại.",
        ],
        ...
        "empty.startProxyToView": [
            .english: "Start the proxy to view quota information",
            .vietnamese: "Khởi động proxy để xem thông tin hạn mức",
        ],
        "empty.noAccounts": [.english: "No Accounts", .vietnamese: "Chưa có tài khoản"],
        "empty.addProviderAccounts": [
            .english: "Add provider accounts to view quota",
            .vietnamese: "Thêm tài khoản nhà cung cấp để xem hạn mức",
        ],
        ...
        "oauth.completeBrowser": [
            .english: "Complete the login in your browser",
            .vietnamese: "Hoàn tất đăng nhập trong trình duyệt",
        ],
        ...
        "oauth.enterCodeInBrowser": [
            .english: "Enter this code in browser",
            .vietnamese: "Nhập mã này trong trình duyệt",
        ],

        "import.vertexKey": [.english: "Import Service Account Key", .vietnamese: "Nhập khóa tài khoản dịch vụ"],
        "import.vertexDesc": [
            .english: "Select the JSON key file for your Vertex AI service account",
            .vietnamese: "Chọn tệp khóa JSON cho tài khoản dịch vụ Vertex AI",
        ],
        ...
        "menubar.openApp": [.english: "Open CKota", .vietnamese: "Mở CKota"],
        "menubar.quit": [.english: "Quit CKota", .vietnamese: "Thoát CKota"],
        ...
        "settings.menubar.selectAccounts": [
            .english: "Select Accounts to Display",
            .vietnamese: "Chọn tài khoản hiển thị",
        ],
        "settings.menubar.selected": [.english: "Displayed", .vietnamese: "Đang hiển thị"],
        "settings.menubar.noQuotaData": [
            .english: "No quota data available. Add accounts with quota support.",
            .vietnamese: "Không có dữ liệu quota. Thêm tài khoản hỗ trợ quota.",
        ],
        "settings.menubar.help": [
            .english: "Choose which accounts to show in the menu bar. Maximum 3 items will be displayed.",
            .vietnamese: "Chọn tài khoản muốn hiển thị trên thanh menu. Tối đa 3 mục.",
        ],
        ...
        "menubar.warning.message": [
            .english: "Displaying more than 3 items may make the menu bar cluttered. Are you sure you want to continue?",
            .vietnamese: "Hiển thị hơn 3 mục có thể làm thanh menu lộn xộn. Bạn có chắc muốn tiếp tục?",
        ],
        ...
        "menubar.info.description": [
            .english: "Click the chart icon to toggle displaying this account's quota in the menu bar.",
            .vietnamese: "Nhấn vào biểu tượng biểu đồ để bật/tắt hiển thị quota của tài khoản này trên menu bar.",
        ],
        ...
        "menubar.hint": [
            .english: "Click the chart icon to toggle menu bar display",
            .vietnamese: "Nhấn biểu tượng biểu đồ để bật/tắt hiển thị trên menu bar",
        ],

        // Quota Display Mode Settings
        "settings.quota.display": [.english: "Quota Display", .vietnamese: "Hiển thị Quota"],
        "settings.quota.display.help": [
            .english: "Choose how to display quota percentages across the app.",
            .vietnamese: "Chọn cách hiển thị phần trăm quota trong ứng dụng.",
        ],
        ...
        "settings.notifications.cooling": [
            .english: "Account Cooling Alert",
            .vietnamese: "Cảnh báo tài khoản đang nghỉ",
        ],
        ...
        "settings.notifications.help": [
            .english: "Get notified when quota is low, accounts enter cooling, or proxy crashes",
            .vietnamese: "Nhận thông báo khi hạn mức thấp, tài khoản đang nghỉ, hoặc proxy bị lỗi",
        ],
        "settings.notifications.notAuthorized": [
            .english: "Notifications not authorized. Enable in System Settings.",
            .vietnamese: "Thông báo chưa được cấp quyền. Bật trong Cài đặt hệ thống.",
        ],

        "notification.quotaLow.title": [.english: "⚠️ Quota Low", .vietnamese: "⚠️ Hạn mức thấp"],
        "notification.quotaLow.body": [
            .english: "%@ (%@): Only %d%% quota remaining",
            .vietnamese: "%@ (%@): Chỉ còn %d%% hạn mức",
        ],
        "notification.cooling.title": [.english: "❄️ Account Cooling", .vietnamese: "❄️ Tài khoản đang nghỉ"],
        "notification.cooling.body": [
            .english: "%@ (%@) has entered cooling status",
            .vietnamese: "%@ (%@) đã vào trạng thái nghỉ",
        ],
        "notification.proxyCrash.title": [.english: "🚨 Proxy Crashed", .vietnamese: "🚨 Proxy bị lỗi"],
        "notification.proxyCrash.body": [
            .english: "Proxy process exited with code %d",
            .vietnamese: "Tiến trình proxy đã thoát với mã %d",
        ],
        "notification.proxyStarted.title": [.english: "✅ Proxy Started", .vietnamese: "✅ Proxy đã khởi động"],
        "notification.proxyStarted.body": [
            .english: "Proxy server is now running",
            .vietnamese: "Máy chủ proxy đang chạy",
        ],
        ...
        "agents.subtitle": [
            .english: "Configure CLI agents to use CLIProxyAPI",
            .vietnamese: "Cấu hình CLI agent để sử dụng CLIProxyAPI",
        ],
        ...
        "agents.mode.automatic.desc": [
            .english: "Directly update config files and shell profile",
            .vietnamese: "Tự động cập nhật file cấu hình và shell profile",
        ],
        "agents.mode.manual.desc": [
            .english: "View and copy configuration manually",
            .vietnamese: "Xem và sao chép cấu hình thủ công",
        ],
        ...
        "agents.copyInstructions": [
            .english: "Copy the configuration below and apply manually",
            .vietnamese: "Sao chép cấu hình bên dưới và áp dụng thủ công",
        ],
        ...
        // Instructions
        "agents.instructions.restart": [
            .english: "Restart your terminal for changes to take effect",
            .vietnamese: "Khởi động lại terminal để thay đổi có hiệu lực",
        ],
        "agents.instructions.env": [
            .english: "Add these environment variables to your shell profile:",
            .vietnamese: "Thêm các biến môi trường này vào shell profile:",
        ],
        "agents.instructions.file": [
            .english: "Configuration files have been created:",
            .vietnamese: "Các tệp cấu hình đã được tạo:",
        ],
        "agents.proxyNotRunning": [
            .english: "Start the proxy to configure agents",
            .vietnamese: "Khởi động proxy để cấu hình agent",
        ],
        ...
        "agents.modelSlotsDesc": [
            .english: "Configure which models to use for each slot",
            .vietnamese: "Cấu hình mô hình sử dụng cho mỗi slot",
        ],
        "agents.useOAuth": [.english: "Use OAuth Authentication", .vietnamese: "Sử dụng xác thực OAuth"],
        "agents.useOAuthDesc": [
            .english: "Use your existing Google OAuth credentials",
            .vietnamese: "Sử dụng thông tin đăng nhập Google OAuth hiện có",
        ],
        ...
        "settings.autoCheckUpdates": [
            ...
            .vietnamese: "Tự động kiểm tra cập nhật",
        ],
        ...
        // About Screen
        "about.tagline": [
            .english: "Your AI Coding Command Center",
            .vietnamese: "Trung tâm điều khiển AI Coding của bạn",
        ],
        "about.description": [
            .english: "CKota is a native macOS application for managing CLIProxyAPI - a local proxy server that powers your AI coding agents. Manage multiple AI accounts, track quotas, and configure CLI tools in one place.",
            .vietnamese: "CKota là ứng dụng macOS để quản lý CLIProxyAPI - máy chủ proxy cục bộ hỗ trợ các AI coding agent. Quản lý nhiều tài khoản AI, theo dõi hạn mức và cấu hình các công cụ CLI tại một nơi.",
        ],
        ...
        "onboarding.installCLIDesc": [
            .english: "Download the proxy binary to get started",
            .vietnamese: "Tải xuống binary proxy để bắt đầu",
        ],
        "onboarding.startProxy": [.english: "Start Proxy Server", .vietnamese: "Khởi động Proxy Server"],
        "onboarding.startProxyDesc": [
            .english: "Start the local proxy to connect AI providers",
            .vietnamese: "Khởi động proxy cục bộ để kết nối các nhà cung cấp AI",
        ],
        "onboarding.addProvider": [.english: "Connect AI Provider", .vietnamese: "Kết nối nhà cung cấp AI"],
        "onboarding.addProviderDesc": [
            .english: "Add at least one AI provider account",
            .vietnamese: "Thêm ít nhất một tài khoản nhà cung cấp AI",
        ],
        ...
        "onboarding.configureAgentDesc": [
            .english: "Set up your AI coding assistant",
            .vietnamese: "Thiết lập trợ lý AI coding của bạn",
        ],
        "onboarding.complete": [.english: "You're All Set!", .vietnamese: "Đã sẵn sàng!"],
        "onboarding.completeDesc": [
            .english: "CKota is ready to supercharge your AI coding",
            .vietnamese: "CKota đã sẵn sàng tăng cường AI coding của bạn",
        ],
        ...
        "dashboard.addAccountsHint": [
            .english: "Add provider accounts to start tracking quotas",
            .vietnamese: "Thêm tài khoản nhà cung cấp để bắt đầu theo dõi quota",
        ],

        // Providers - Quota-Only Mode
        "providers.noAccountsFound": [.english: "No accounts found", .vietnamese: "Không tìm thấy tài khoản"],
        "providers.quotaOnlyHint": [
            .english: "Auth files will be detected from CLI Proxy API and native CLI locations",
            .vietnamese: "File xác thực sẽ được phát hiện từ CLI Proxy API và các vị trí CLI gốc",
        ],
        ...
        "empty.refreshToLoad": [
            .english: "Refresh to load quota information",
            .vietnamese: "Làm mới để tải thông tin quota",
        ],
        ...
        "settings.appMode.quotaOnlyNote": [
            .english: "Proxy server is disabled in Quota Monitor mode",
            .vietnamese: "Máy chủ proxy bị tắt trong chế độ Theo dõi Quota",
        ],
        "settings.appMode.switchConfirmTitle": [
            .english: "Switch to Quota Monitor Mode?",
            .vietnamese: "Chuyển sang chế độ Theo dõi Quota?",
        ],
        "settings.appMode.switchConfirmMessage": [
            .english: "This will stop the proxy server if running. You can switch back anytime.",
            .vietnamese: "Điều này sẽ dừng máy chủ proxy nếu đang chạy. Bạn có thể chuyển lại bất cứ lúc nào.",
        ],
        ...
        "settings.appearance.help": [
            .english: "Choose how the app looks. System will automatically match your Mac's appearance.",
            .vietnamese: "Chọn giao diện cho ứng dụng. Hệ thống sẽ tự động theo giao diện của Mac.",
        ],

        // Settings Tabs
        "settings.tab.general": [.english: "General", .vietnamese: "Chung"],
        "settings.tab.proxy": [.english: "Proxy", .vietnamese: "Proxy"],
        "settings.tab.notifications": [.english: "Notifications", .vietnamese: "Thông báo"],
        "settings.tab.advanced": [.english: "Advanced", .vietnamese: "Nâng cao"],
    ]
