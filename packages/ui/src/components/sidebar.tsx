...
import { Skeleton } from '@quotio/ui/components/skeleton';
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from '@quotio/ui/components/tooltip';
import { useIsMobile } from '@quotio/ui/hooks/use-mobile';
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn sidebar pattern uses cookie for SSR state persistence
