...
pub const REQUEST_KINDS: &[&str] = &["runtime.status", "runtime.start", "runtime.stop", "runtime.restart", "management.request", "native.confirm", "native.notify", "native.openExternal", "native.openTextFile", "native.credentialRead", "native.credentialWrite", "native.credentialDelete"];
