...
struct LocalizedStrings {
    private static let strings: [String: [AppLanguage: String]] = [
        // Navigation
        "nav.dashboard": [.english: "Dashboard", .vietnamese: "Bảng điều khiển", .chinese: "仪表盘"],
        ...
        "status.forbidden": [.english: "Forbidden", .vietnamese: "Bị chặn", .chinese: "禁止"],
        ...
        "dashboard.tokens": [.english: "Tokens", .vietnamese: "Token", .chinese: "Token"],
        ...
        "quota.used": [.english: "used", .vietnamese: "đã dùng", .chinese: "已用"],
        ...
        "providers.noAccountsYet": [.english: "No accounts connected yet", .vietnamese: "Chưa có tài khoản nào được kết nối", .chinese: "暂无连接账户"],
        "providers.startProxyFirst": [.english: "Start the proxy first to manage providers", .vietnamese: "Khởi động proxy trước để quản lý nhà cung cấp", .chinese: "请先启动代理以管理提供商"],
        "providers.connect": [.english: "Connect", .vietnamese: "Kết nối", .chinese: "连接"],
        "providers.authenticate": [.english: "Authenticate", .vietnamese: "Xác thực", .chinese: "验证"],
        "providers.cancel": [.english: "Cancel", .vietnamese: "Hủy", .chinese: "取消"],
        "providers.waitingAuth": [.english: "Waiting for authentication...", .vietnamese: "Đang chờ xác thực...", .chinese: "等待验证..."],
        "providers.connectedSuccess": [.english: "Connected successfully!", .vietnamese: "Kết nối thành công!", .chinese: "连接成功！"],
        "providers.authFailed": [.english: "Authentication failed", .vietnamese: "Xác thực thất bại", .chinese: "验证失败"],
        ...
        "settings.autoStartProxy": [.english: "Auto-start proxy on launch", .vietnamese: "Tự khởi động proxy khi mở app", .chinese: "启动时自动运行代理"],
        ...
        "settings.roundRobinDesc": [.english: "Distributes requests evenly across all accounts", .vietnamese: "Phân phối yêu cầu đều cho tất cả tài khoản", .chinese: "将请求均匀分配给所有账户"],
        ...
        "settings.quotaExceededHelp": [.english: "When quota is exceeded, automatically try alternative accounts or models", .vietnamese: "Khi vượt hạn mức, tự động thử tài khoản hoặc mô hình khác", .chinese: "当配额超限时，自动尝试替代账户或模型"],
        ...
        "settings.retryHelp": [.english: "Number of times to retry failed requests (403, 408, 500, 502, 503, 504)", .vietnamese: "Số lần thử lại yêu cầu thất bại (403, 408, 500, 502, 503, 504)", .chinese: "请求失败 (403, 408, 500, 502, 503, 504) 时的重试次数"],
        "settings.logging": [.english: "Logging", .vietnamese: "Ghi nhật ký", .chinese: "日志记录"],
        "settings.loggingToFile": [.english: "Log to file", .vietnamese: "Ghi nhật ký ra file", .chinese: "记录到文件"],
        "settings.loggingHelp": [.english: "Write application logs to rotating files instead of stdout. Disable to log to stdout/stderr.", .vietnamese: "Ghi nhật ký vào file xoay vòng thay vì stdout. Tắt để ghi ra stdout/stderr.", .chinese: "将应用日志写入轮转文件而不是 stdout。禁用以记录到 stdout/stderr。"],
        ...
        "settings.authDir": [.english: "Auth Dir", .vietnamese: "Thư mục xác thực", .chinese: "验证目录"],
        ...
        "settings.apiKeysHelp": [.english: "API keys for clients to authenticate with the proxy", .vietnamese: "Khóa API để các client xác thực với proxy", .chinese: "客户端用于通过代理进行身份验证的 API 密钥"],
        ...
        "apiKeys.description": [.english: "API keys for clients to authenticate with the proxy service", .vietnamese: "Khóa API để các client xác thực với dịch vụ proxy", .chinese: "客户端用于通过代理服务进行身份验证的 API 密钥"],
        ...
        "apiKeys.emptyDescription": [.english: "Add API keys to authenticate clients with the proxy", .vietnamese: "Thêm khóa API để xác thực client với proxy", .chinese: "添加 API 密钥以验证客户端与代理的连接"],
        ...
        "logs.logsWillAppear": [.english: "Logs will appear here as requests are processed", .vietnamese: "Nhật ký sẽ xuất hiện khi có yêu cầu được xử lý", .chinese: "处理请求时日志将显示在此处"],
        ...
        // Actions
        "action.start": [.english: "Start", .vietnamese: "Bắt đầu", .chinese: "启动"],
        ...
        "subscription.freeTier": [.english: "Free Tier", .vietnamese: "Gói miễn phí", .chinese: "免费版"],
        ...
        "oauth.authenticateWith": [.english: "Authenticate with your", .vietnamese: "Xác thực với tài khoản", .chinese: "登录到"],
        ...
        "oauth.authenticate": [.english: "Authenticate", .vietnamese: "Xác thực", .chinese: "验证"],
        ...
        "oauth.waitingForAuth": [.english: "Waiting for authentication", .vietnamese: "Đang chờ xác thực", .chinese: "等待验证"],
        ...
        "oauth.failed": [.english: "Authentication failed", .vietnamese: "Xác thực thất bại", .chinese: "验证失败"],
        "oauth.timeout": [.english: "Authentication timeout", .vietnamese: "Hết thời gian xác thực", .chinese: "验证超时"],
        "oauth.authMethod": [.english: "Authentication Method", .vietnamese: "Phương thức xác thực", .chinese: "验证方式"],
        ...
        "menubar.quota": [.english: "Quota Usage", .vietnamese: "Sử dụng hạn mức", .chinese: "配额使用情况"],
        ...
        "settings.menubar.noQuotaData": [.english: "No quota data available. Add accounts with quota support.", .vietnamese: "Không có dữ liệu quota. Thêm tài khoản hỗ trợ quota.", .chinese: "无配额数据。添加支持配额的账户。"],
        ...
        "menubar.limitReached": [.english: "Menu bar limit reached", .vietnamese: "Đã đạt giới hạn Menu Bar", .chinese: "已达菜单栏限制"],
        
        "menubar.warning.title": [.english: "Too Many Items", .vietnamese: "Quá nhiều mục", .chinese: "项目过多"],
        "menubar.warning.message": [.english: "Displaying more than 3 items may make the menu bar cluttered. Are you sure you want to continue?", .vietnamese: "Hiển thị hơn 3 mục có thể làm thanh menu lộn xộn. Bạn có chắc muốn tiếp tục?", .chinese: "显示超过 3 个项目可能会使菜单栏杂乱。确定要继续吗？"],
        ...
        "menubar.info.description": [.english: "Click the chart icon to toggle displaying this account's quota in the menu bar.", .vietnamese: "Nhấn vào biểu tượng biểu đồ để bật/tắt hiển thị quota của tài khoản này trên menu bar.", .chinese: "点击图表图标以切换在菜单栏显示此账户的配额。"],
        "menubar.info.enabled": [.english: "Showing in menu bar", .vietnamese: "Đang hiển thị trên menu bar", .chinese: "正在菜单栏显示"],
        "menubar.info.disabled": [.english: "Not showing in menu bar", .vietnamese: "Không hiển thị trên menu bar", .chinese: "未在菜单栏显示"],
        "menubar.hint": [.english: "Click the chart icon to toggle menu bar display", .vietnamese: "Nhấn biểu tượng biểu đồ để bật/tắt hiển thị trên menu bar", .chinese: "点击图表图标切换菜单栏显示"],
        
        // Quota Display Mode Settings
        "settings.quota.display": [.english: "Quota Display", .vietnamese: "Hiển thị Quota", .chinese: "配额显示"],
        "settings.quota.display.help": [.english: "Choose how to display quota percentages across the app.", .vietnamese: "Chọn cách hiển thị phần trăm quota trong ứng dụng.", .chinese: "选择在应用中显示配额百分比的方式。"],
        "settings.quota.displayMode": [.english: "Display Mode", .vietnamese: "Chế độ hiển thị", .chinese: "显示模式"],
        "settings.quota.displayMode.used": [.english: "Used", .vietnamese: "Đã dùng", .chinese: "已用"],
        "settings.quota.displayMode.remaining": [.english: "Remaining", .vietnamese: "Còn lại", .chinese: "剩余"],
        "settings.quota.used": [.english: "used", .vietnamese: "đã dùng", .chinese: "已用"],
        ...
        "settings.notifications.cooling": [.english: "Account Cooling Alert", .vietnamese: "Cảnh báo tài khoản đang nghỉ", .chinese: "账户冷却提醒"],
        "settings.notifications.proxyCrash": [.english: "Proxy Crash Alert", .vietnamese: "Cảnh báo proxy bị lỗi", .chinese: "代理崩溃提醒"],
        ...
        "settings.notifications.help": [.english: "Get notified when quota is low, accounts enter cooling, proxy crashes, or updates are available", .vietnamese: "Nhận thông báo khi hạn mức thấp, tài khoản đang nghỉ, proxy bị lỗi, hoặc có bản cập nhật", .chinese: "当配额低、账户进入冷却、代理崩溃或有更新时获取通知"],
        "settings.notifications.notAuthorized": [.english: "Notifications not authorized. Enable in System Settings.", .vietnamese: "Thông báo chưa được cấp quyền. Bật trong Cài đặt hệ thống.", .chinese: "未授权通知。请在系统设置中启用。"],
        ...
        // Agent Setup
        "nav.agents": [.english: "Agents", .vietnamese: "Agent", .chinese: "Agent"],
        "agents.title": [.english: "AI Agent Setup", .vietnamese: "Cài đặt AI Agent", .chinese: "AI Agent 设置"],
        "agents.subtitle": [.english: "Configure CLI agents to use CLIProxyAPI", .vietnamese: "Cấu hình CLI agent để sử dụng CLIProxyAPI", .chinese: "配置 CLI agent 以使用 CLIProxyAPI"],
        ...
        "agents.mode.automatic.desc": [.english: "Directly update config files and shell profile", .vietnamese: "Tự động cập nhật file cấu hình và shell profile", .chinese: "直接更新配置文件和 Shell Profile"],
        ...
        "agents.copyInstructions": [.english: "Copy the configuration below and apply manually", .vietnamese: "Sao chép cấu hình bên dưới và áp dụng thủ công", .chinese: "复制以下配置并手动应用"],
        
        // Model Slots
        "agents.modelSlots": [.english: "Model Slots", .vietnamese: "Slot mô hình", .chinese: "模型槽位"],
        ...
        "agents.addToShell": [.english: "Add to Shell Profile", .vietnamese: "Thêm vào Shell Profile", .chinese: "添加到 Shell Profile"],
        "agents.shellAdded": [.english: "Added to shell profile", .vietnamese: "Đã thêm vào shell profile", .chinese: "已添加到 Shell Profile"],
        "agents.copied": [.english: "Copied to clipboard", .vietnamese: "Đã sao chép", .chinese: "已复制到剪贴板"],
        ...
        "agents.instructions.env": [.english: "Add these environment variables to your shell profile:", .vietnamese: "Thêm các biến môi trường này vào shell profile:", .chinese: "将这些环境变量添加到您的 Shell Profile："],
        "agents.instructions.file": [.english: "Configuration files have been created:", .vietnamese: "Các tệp cấu hình đã được tạo:", .chinese: "已创建配置文件："],
        "agents.proxyNotRunning": [.english: "Start the proxy to configure agents", .vietnamese: "Khởi động proxy để cấu hình agent", .chinese: "启动代理以配置 agent"],
        "agents.proxyRequired.title": [.english: "Proxy Required", .vietnamese: "Cần khởi động Proxy", .chinese: "需要代理"],
        "agents.proxyRequired.message": [.english: "The proxy server must be running to configure agents. Start the proxy first.", .vietnamese: "Cần khởi động proxy để cấu hình agent. Hãy khởi động proxy trước.", .chinese: "必须运行代理服务器才能配置 agent。请先启动代理。"],
        
        // Auth Modes
        "agents.oauthMode": [.english: "Use OAuth Authentication", .vietnamese: "Sử dụng xác thực OAuth", .chinese: "使用 OAuth 验证"],
        "agents.apiKeyMode": [.english: "Use API Key Authentication", .vietnamese: "Sử dụng xác thực API Key", .chinese: "使用 API 密钥验证"],
        ...
        "agents.modelSlotsDesc": [.english: "Configure which models to use for each slot", .vietnamese: "Cấu hình mô hình sử dụng cho mỗi slot", .chinese: "配置每个槽位使用的模型"],
        "agents.useOAuth": [.english: "Use OAuth Authentication", .vietnamese: "Sử dụng xác thực OAuth", .chinese: "使用 OAuth 验证"],
        "agents.useOAuthDesc": [.english: "Use your existing Google OAuth credentials", .vietnamese: "Sử dụng thông tin đăng nhập Google OAuth hiện có", .chinese: "使用您现有的 Google OAuth 凭证"],
        ...
        // Actions (more)
        "action.copyAll": [.english: "Copy All", .vietnamese: "Sao chép tất cả", .chinese: "复制全部"],
        ...
        "agents.storage.jsonOnly": [.english: "JSON Config", .vietnamese: "JSON Config", .chinese: "JSON Config"],
        "agents.storage.shellOnly": [.english: "Shell Profile", .vietnamese: "Shell Profile", .chinese: "Shell Profile"],
        ...
        "settings.proxyUpdate.available": [.english: "Update Available", .vietnamese: "Có bản cập nhật", .chinese: "更新可用"],
        ...
        "settings.proxyUpdate.proxyMustRun": [.english: "Proxy must be running to check for updates", .vietnamese: "Proxy phải đang chạy để kiểm tra cập nhật", .chinese: "必须运行代理才能检查更新"],
        "settings.proxyUpdate.help": [.english: "Managed updates with dry-run validation ensure safe upgrades", .vietnamese: "Cập nhật có kiểm soát với xác thực thử nghiệm đảm bảo nâng cấp an toàn", .chinese: "通过预运行验证进行受控更新，确保升级安全"],
        
        // Proxy Updates - Advanced Mode
        "settings.proxyUpdate.advanced": [.english: "Advanced", .vietnamese: "Nâng cao", .chinese: "高级"],
        "settings.proxyUpdate.advanced.title": [.english: "Version Manager", .vietnamese: "Quản lý phiên bản", .chinese: "版本管理"],
        "settings.proxyUpdate.advanced.description": [.english: "Install a specific proxy version", .vietnamese: "Cài đặt phiên bản proxy cụ thể", .chinese: "安装特定代理版本"],
        ...
        "settings.proxyUpdate.advanced.loading": [.english: "Loading releases...", .vietnamese: "Đang tải danh sách...", .chinese: "正在加载版本列表..."],
        ...
        "settings.proxyUpdate.advanced.fetchError": [.english: "Failed to fetch releases", .vietnamese: "Không thể tải danh sách phiên bản", .chinese: "获取版本失败"],
        ...
        "about.agentConfig": [.english: "Agent Config", .vietnamese: "Cấu hình Agent", .chinese: "Agent 配置"],
        ...
        "about.madeWith": [.english: "Made with ❤️ in Vietnam", .vietnamese: "Được tạo với ❤️ tại Việt Nam", .chinese: "在越南用 ❤️ 打造"],
        ...
        "onboarding.addProviderDesc": [.english: "Add at least one AI provider account", .vietnamese: "Thêm ít nhất một tài khoản nhà cung cấp AI", .chinese: "添加至少一个 AI 提供商账户"],
        "onboarding.connectAccount": [.english: "Connect Account", .vietnamese: "Kết nối tài khoản", .chinese: "连接账户"],
        "onboarding.configureAgent": [.english: "Configure CLI Agent", .vietnamese: "Cấu hình CLI Agent", .chinese: "配置 CLI Agent"],
        ...
        "onboarding.complete": [.english: "You're All Set!", .vietnamese: "Đã sẵn sàng!", .chinese: "准备就绪！"],
        "onboarding.completeDesc": [.english: "Quotio is ready to supercharge your AI coding", .vietnamese: "Quotio đã sẵn sàng tăng cường AI coding của bạn", .chinese: "Quotio 已准备好增强您的 AI 编码体验"],
        "onboarding.skip": [.english: "Skip Setup", .vietnamese: "Bỏ qua", .chinese: "跳过设置"],
        "onboarding.goToDashboard": [.english: "Go to Dashboard", .vietnamese: "Đến Dashboard", .chinese: "前往仪表盘"],
        "onboarding.providersConfigured": [.english: "providers connected", .vietnamese: "nhà cung cấp đã kết nối", .chinese: "已连接提供商"],
        "onboarding.agentsConfigured": [.english: "agents configured", .vietnamese: "agent đã cấu hình", .chinese: "已配置 agent"],
        
        // Dashboard
        "dashboard.gettingStarted": [.english: "Getting Started", .vietnamese: "Bắt đầu", .chinese: "新手入门"],
        "action.dismiss": [.english: "Dismiss", .vietnamese: "Ẩn", .chinese: "忽略"],
        ...
        "dashboard.noAccountsTracked": [.english: "No accounts tracked", .vietnamese: "Chưa theo dõi tài khoản nào", .chinese: "未跟踪任何账户"],
        ...
        "providers.quotaOnlyHint": [.english: "Auth files will be detected from ~/.cli-proxy-api and native CLI locations", .vietnamese: "File xác thực sẽ được phát hiện từ ~/.cli-proxy-api và các vị trí CLI gốc", .chinese: "将从 ~/.cli-proxy-api 和原生 CLI 位置检测认证文件"],
        ...
        "menubar.noData": [.english: "No quota data available", .vietnamese: "Chưa có dữ liệu quota", .chinese: "无配额数据"],
        ...
        // Status - New
        "status.refreshing": [.english: "Refreshing...", .vietnamese: "Đang làm mới...", .chinese: "正在刷新..."],
        ...
        "settings.appMode.switchConfirmMessage": [.english: "This will stop the proxy server if running. You can switch back anytime.", .vietnamese: "Điều này sẽ dừng máy chủ proxy nếu đang chạy. Bạn có thể chuyển lại bất cứ lúc nào.", .chinese: "如果代理服务器正在运行，此操作将停止它。您可以随时切换回来。"],
        ...
        "settings.appearance.help": [.english: "Choose how the app looks. System will automatically match your Mac's appearance.", .vietnamese: "Chọn giao diện cho ứng dụng. Hệ thống sẽ tự động theo giao diện của Mac.", .chinese: "选择应用的外观。系统模式将自动匹配您的 Mac 外观。"],
        ...
        "ideScan.privacyNotice": [.english: "Privacy Notice", .vietnamese: "Thông báo bảo mật", .chinese: "隐私声明"],
        "ideScan.privacyDescription": [.english: "This will access files from other applications to detect installed IDEs and their authentication status. No data is sent externally.", .vietnamese: "Thao tác này sẽ truy cập file từ các ứng dụng khác để phát hiện IDE đã cài đặt và trạng thái xác thực. Không có dữ liệu nào được gửi ra ngoài.", .chinese: "此操作将访问其他应用程序的文件以检测已安装的 IDE 及其验证状态。不会向外部发送任何数据。"],
        ...
        "ideScan.scanning": [.english: "Scanning...", .vietnamese: "Đang quét...", .chinese: "正在扫描..."],
        ...
        "notification.upgrade.success.body": [.english: "CLIProxyAPI has been upgraded to version %@", .vietnamese: "CLIProxyAPI đã được nâng cấp lên phiên bản %@", .chinese: "CLIProxyAPI 已升级至版本 %@"],
        "notification.upgrade.failed.title": [.english: "Proxy Upgrade Failed", .vietnamese: "Nâng cấp Proxy thất bại", .chinese: "代理升级失败"],
        "notification.upgrade.failed.body": [.english: "Failed to upgrade to version %@: %@", .vietnamese: "Không thể nâng cấp lên phiên bản %@: %@", .chinese: "升级至版本 %@ 失败: %@"],
        "notification.rollback.title": [.english: "Proxy Rollback", .vietnamese: "Khôi phục Proxy", .chinese: "代理回滚"],
        "notification.rollback.body": [.english: "Rolled back to version %@ due to upgrade failure", .vietnamese: "Đã khôi phục về phiên bản %@ do nâng cấp thất bại", .chinese: "由于升级失败，已回滚至版本 %@"],
        ...
        "settings.proxyUpdate.deleteWarning.message": [.english: "Installing this version will delete the following old versions to keep only %d most recent: %@", .vietnamese: "Cài đặt phiên bản này sẽ xóa các phiên bản cũ sau để chỉ giữ lại %d phiên bản gần nhất: %@", .chinese: "安装此版本将删除以下旧版本，仅保留最近的 %d 个版本: %@"],
