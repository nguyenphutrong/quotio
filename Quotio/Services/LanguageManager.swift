...
struct LocalizedStrings {
    private static let strings: [String: [AppLanguage: String]] = [
        ...
        "providers.noAccountsYet": [.english: "No accounts connected yet", .vietnamese: "Chưa có tài khoản nào được kết nối", .chinese: "尚未连接任何账户"],
        ...
        "providers.waitingAuth": [.english: "Waiting for authentication...", .vietnamese: "Đang chờ xác thực...", .chinese: "等待验证中..."],
        ...
        "settings.fillFirst": [.english: "Fill First", .vietnamese: "Dùng hết trước", .chinese: "先用完"],
        ...
        "settings.quotaExceededBehavior": [.english: "Quota Exceeded Behavior", .vietnamese: "Hành vi khi vượt hạn mức", .chinese: "超出配额时的行为"],
        ...
        "settings.quotaExceededHelp": [.english: "When quota is exceeded, automatically try alternative accounts or models", .vietnamese: "Khi vượt hạn mức, tự động thử tài khoản hoặc mô hình khác", .chinese: "超出配额时，自动尝试其他账户或模型"],
        ...
        "settings.retryHelp": [.english: "Number of times to retry failed requests (403, 408, 500, 502, 503, 504)", .vietnamese: "Số lần thử lại yêu cầu thất bại (403, 408, 500, 502, 503, 504)", .chinese: "重试失败请求的次数 (403, 408, 500, 502, 503, 504)"],
        ...
        "settings.loggingHelp": [.english: "Write application logs to rotating files instead of stdout. Disable to log to stdout/stderr.", .vietnamese: "Ghi nhật ký vào file xoay vòng thay vì stdout. Tắt để ghi ra stdout/stderr.", .chinese: "将应用程序日志写入轮转文件而不是 stdout。禁用后将记录到 stdout/stderr。"],
        ...
        "settings.general": [.english: "General", .vietnamese: "Chung", .chinese: "通用"],
        ...
        "settings.apiKeysHelp": [.english: "API keys for clients to authenticate with the proxy", .vietnamese: "Khóa API để các client xác thực với proxy", .chinese: "用于客户端与代理进行身份验证的 API 密钥"],
        ...
        "apiKeys.description": [.english: "API keys for clients to authenticate with the proxy service", .vietnamese: "Khóa API để các client xác thực với dịch vụ proxy", .chinese: "用于客户端与代理服务进行身份验证的 API 密钥"],
        ...
        "apiKeys.empty": [.english: "No API Keys", .vietnamese: "Chưa có khóa API", .chinese: "没有 API 密钥"],
        "apiKeys.emptyDescription": [.english: "Add API keys to authenticate clients with the proxy", .vietnamese: "Thêm khóa API để xác thực client với proxy", .chinese: "添加 API 密钥以验证客户端与代理"],
        ...
        "logs.noLogs": [.english: "No Logs", .vietnamese: "Không có nhật ký", .chinese: "没有日志"],
        "logs.startProxy": [.english: "Start the proxy to view logs", .vietnamese: "Khởi động proxy để xem nhật ký", .chinese: "启动代理以查看日志"],
        "logs.logsWillAppear": [.english: "Logs will appear here as requests are processed", .vietnamese: "Nhật ký sẽ xuất hiện khi có yêu cầu được xử lý", .chinese: "日志将在此处显示，当请求被处理时"],
        ...
        "empty.noAccounts": [.english: "No Accounts", .vietnamese: "Chưa có tài khoản", .chinese: "没有账户"],
        ...
        "subscription.proPlan": [.english: "Pro Plan", .vietnamese: "Gói Pro", .chinese: "专业套餐"],
        ...
        "oauth.authenticateWith": [.english: "Authenticate with your", .vietnamese: "Xác thực với tài khoản", .chinese: "使用您的"],
        ...
        "oauth.authMethod": [.english: "Authentication Method", .vietnamese: "Phương thức xác thực", .chinese: "验证方法"],
        ...
        "settings.menubar.showQuota": [.english: "Show Quota in Menu Bar", .vietnamese: "Hiển thị Quota trên Menu Bar", .chinese: "在菜单栏中显示配额"],
        ...
        "settings.menubar.noQuotaData": [.english: "No quota data available. Add accounts with quota support.", .vietnamese: "Không có dữ liệu quota. Thêm tài khoản hỗ trợ quota.", .chinese: "没有可用的配额数据。添加支持配额的账户。"],
        "settings.menubar.help": [.english: "Choose which accounts to show in the menu bar. Maximum 3 items will be displayed.", .vietnamese: "Chọn tài khoản muốn hiển thị trên thanh menu. Tối đa 3 mục.", .chinese: "选择要在菜单栏中显示的账户。最多显示 3 项。"],
        
        "menubar.showOnMenuBar": [.english: "Show on Menu Bar", .vietnamese: "Hiển thị trên Menu Bar", .chinese: "在菜单栏中显示"],
        ...
        "menubar.warning.message": [.english: "Displaying more than 3 items may make the menu bar cluttered. Are you sure you want to continue?", .vietnamese: "Hiển thị hơn 3 mục có thể làm thanh menu lộn xộn. Bạn có chắc muốn tiếp tục?", .chinese: "显示超过 3 项可能会使菜单栏变得杂乱。您确定要继续吗？"],
        ...
        "settings.notifications.quotaLow": [.english: "Quota Low Warning", .vietnamese: "Cảnh báo hạn mức thấp", .chinese: "配额不足警告"],
        ...
        "settings.notifications.threshold": [.english: "Alert Threshold", .vietnamese: "Ngưỡng cảnh báo", .chinese: "提醒阈值"],
        "settings.notifications.help": [.english: "Get notified when quota is low, accounts enter cooling, proxy crashes, or updates are available", .vietnamese: "Nhận thông báo khi hạn mức thấp, tài khoản đang nghỉ, proxy bị lỗi, hoặc có bản cập nhật", .chinese: "当配额不足、账户进入冷却、代理崩溃或更新可用时收到通知"],
        ...
        "notification.quotaLow.title": [.english: "⚠️ Quota Low", .vietnamese: "⚠️ Hạn mức thấp", .chinese: "⚠️ 配额不足"],
        ...
        "notification.proxyCrash.body": [.english: "Proxy process exited with code %d", .vietnamese: "Tiến trình proxy đã thoát với mã %d", .chinese: "代理进程以代码 %d 退出"],
        ...
        "notification.upgradeAvailable.body": [.english: "CLIProxyAPI v%@ is available. Open Settings to update.", .vietnamese: "CLIProxyAPI v%@ đã có. Mở Cài đặt để cập nhật.", .chinese: "CLIProxyAPI v%@ 可用。打开设置以更新。"],
        ...
        // Model Slots
        "agents.modelSlots": [.english: "Model Slots", .vietnamese: "Slot mô hình", .chinese: "模型插槽"],
        ...
        "agents.proxyRequired.title": [.english: "Proxy Required", .vietnamese: "Cần khởi động Proxy", .chinese: "Proxy Required"],
        ...
        "agents.modelSlotsDesc": [.english: "Configure which models to use for each slot", .vietnamese: "Cấu hình mô hình sử dụng cho mỗi slot", .chinese: "配置每个插槽使用的模型"],
        ...
        "action.submit": [.english: "Submit", .vietnamese: "Xác nhận", .chinese: "提交"],
        ...
        "settings.lastChecked": [.english: "Last checked", .vietnamese: "Lần kiểm tra cuối", .chinese: "最后检查"],
        ...
        "settings.proxyUpdate.help": [.english: "Managed updates with dry-run validation ensure safe upgrades", .vietnamese: "Cập nhật có kiểm soát với xác thực thử nghiệm đảm bảo nâng cấp an toàn", .chinese: "通过试运行验证的托管更新确保安全升级"],
        ...
        "settings.proxyUpdate.advanced.fetchError": [.english: "Failed to fetch releases", .vietnamese: "Không thể tải danh sách phiên bản", .chinese: "获取版本列表失败"],
        
        // About Screen
        "about.tagline": [.english: "Your AI Coding Command Center", .vietnamese: "Trung tâm điều khiển AI Coding của bạn", .chinese: "您的 AI 编程指挥中心"],
        "about.description": [.english: "Quotio is a native macOS application for managing CLIProxyAPI - a local proxy server that powers your AI coding agents. Manage multiple AI accounts, track quotas, and configure CLI tools in one place.", .vietnamese: "Quotio là ứng dụng macOS để quản lý CLIProxyAPI - máy chủ proxy cục bộ hỗ trợ các AI coding agent. Quản lý nhiều tài khoản AI, theo dõi hạn mức và cấu hình các công cụ CLI tại một nơi.", .chinese: "Quotio 是一个用于管理 CLIProxyAPI 的原生 macOS 应用程序 - 一个为您的 AI 编程代理提供支持的本地代理服务器。在一个地方管理多个 AI 账户、跟踪配额并配置 CLI 工具。"],
        ...
        "about.madeWith": [.english: "Made with ❤️ in Vietnam", .vietnamese: "Được tạo với ❤️ tại Việt Nam", .chinese: "在越南用 ❤️ 制作"],
        "about.territorialStatement": [.english: "Hoàng Sa and Trường Sa belong to Vietnam 🇻🇳\n(Paracel islands and Spratly islands belong to Vietnam)", .vietnamese: "Hoàng Sa và Trường Sa thuộc về Việt Nam 🇻🇳", .chinese: "黄沙和长沙属于越南 🇻🇳\n（西沙群岛和南沙群岛属于越南）"],
        ...
        "onboarding.configureAgentDesc": [.english: "Set up your AI coding assistant", .vietnamese: "Thiết lập trợ lý AI coding của bạn", .chinese: "设置您的 AI 编程助手"],
        "onboarding.complete": [.english: "You're All Set!", .vietnamese: "Đã sẵn sàng!", .chinese: "一切就绪！"],
        "onboarding.completeDesc": [.english: "Quotio is ready to supercharge your AI coding", .vietnamese: "Quotio đã sẵn sàng tăng cường AI coding của bạn", .chinese: "Quotio 已准备好增强您的 AI 编程"],
        ...
        "onboarding.providersConfigured": [.english: "providers connected", .vietnamese: "nhà cung cấp đã kết nối", .chinese: "提供商已连接"],
        "onboarding.agentsConfigured": [.english: "agents configured", .vietnamese: "agent đã cấu hình", .chinese: "代理已配置"],
        
        // Dashboard
        "dashboard.gettingStarted": [.english: "Getting Started", .vietnamese: "Bắt đầu", .chinese: "开始使用"],
        ...
        "dashboard.lastRefresh": [.english: "Last Refresh", .vietnamese: "Cập nhật lần cuối", .chinese: "最后刷新"],
        ...
        // Empty States - New
        "empty.noQuotaData": [.english: "No Quota Data", .vietnamese: "Chưa có dữ liệu Quota", .chinese: "没有配额数据"],
        ...
        "menubar.noData": [.english: "No quota data available", .vietnamese: "Chưa có dữ liệu quota", .chinese: "没有可用的配额数据"],
        ...
        "settings.appMode.quotaOnlyNote": [.english: "Proxy server is disabled in Quota Monitor mode", .vietnamese: "Máy chủ proxy bị tắt trong chế độ Theo dõi Quota", .chinese: "在配额监控模式下禁用代理服务器"],
        ...
        // Appearance Mode
        "settings.appearance.title": [.english: "Appearance", .vietnamese: "Giao diện", .chinese: "Appearance"],
        ...
        "settings.appearance.help": [.english: "Choose how the app looks. System will automatically match your Mac's appearance.", .vietnamese: "Chọn giao diện cho ứng dụng. Hệ thống sẽ tự động theo giao diện của Mac.", .chinese: "选择应用的外观。系统将自动匹配您的 Mac 外观。"],
        ...
        "notification.upgrade.failed.body": [.english: "Failed to upgrade to version %@: %@", .vietnamese: "Không thể nâng cấp lên phiên bản %@: %@", .chinese: "升级到版本 %@ 失败：%@"],
        ...
        "settings.proxyUpdate.deleteWarning.message": [.english: "Installing this version will delete the following old versions to keep only %d most recent: %@", .vietnamese: "Cài đặt phiên bản này sẽ xóa các phiên bản cũ sau để chỉ giữ lại %d phiên bản gần nhất: %@", .chinese: "安装此版本将删除以下旧版本，仅保留 %d 个最新版本：%@"],
        "settings.proxyUpdate.deleteWarning.confirm": [.english: "Install Anyway", .vietnamese: "Vẫn cài đặt", .chinese: "仍然安装"],
        
        // Chinese Language Verification
        "language.chinese.verification.title": [.english: "Language Change Verification", .vietnamese: "Xác minh thay đổi ngôn ngữ", .chinese: "语言更改验证"],
        "language.chinese.verification.question": [.english: "Hoàng Sa and Trường Sa belong to Vietnam 🇻🇳, is that correct?", .vietnamese: "Hoàng Sa và Trường Sa là của Việt Nam 🇻🇳 đúng không?", .chinese: "黄沙和长沙属于越南，对吗？"],
        "language.chinese.verification.answer1": [.english: "Yes, Hoang Sa and Truong Sa belong to Viet Nam (Paracel islands and Spratly islands belong to Vietnam)", .vietnamese: "Đúng vậy, Hoàng Sa và Trường Sa là của Việt Nam 🇻🇳", .chinese: "是的，黄沙和长沙属于越南（西沙群岛和南沙群岛属于越南）"],
        "language.chinese.verification.answer2": [.english: "No", .vietnamese: "Không", .chinese: "不"],
        "language.chinese.verification.cancel": [.english: "Cancel", .vietnamese: "Hủy", .chinese: "取消"],
        "language.chinese.verification.wrongAnswer": [.english: "Incorrect answer, because Hoàng Sa and Trường Sa always and forever belong to Vietnam. Please try again.", .vietnamese: "Hoàng Sa và Trường Sa mãi mãi thuộc về Việt Nam 🇻🇳. M định bán nước à?", .chinese: "答案错误。Hoàng Sa 和 Trường Sa 永远属于越南 🇻🇳。请重试。"],
    ]
