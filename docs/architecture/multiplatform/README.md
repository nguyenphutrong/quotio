...
crash-report capture with optional upload, and Codex/OpenCode install/rollback
are available. Native onboarding and automatic configuration for remaining
agents stay disabled until their adapters are implemented and verified on
Windows CI.
