...
## Quotio/ViewModels/QuotaViewModel.swift (1982 lines)
...
| 518 | fn | refreshGlmQuotasInternal | (private) |
| 528 | fn | refreshWarpQuotasInternal | (private) |
| 552 | fn | refreshTraeQuotasInternal | (private) |
| 562 | fn | refreshKiroQuotasInternal | (private) |
| 568 | fn | cleanName | (internal) |
| 616 | fn | startQuotaOnlyAutoRefresh | (private) |
| 634 | fn | startQuotaAutoRefreshWithoutProxy | (private) |
| 653 | fn | isWarmupEnabled | (internal) |
| 657 | fn | warmupStatus | (internal) |
| 662 | fn | warmupNextRunDate | (internal) |
| 667 | fn | toggleWarmup | (internal) |
| 676 | fn | setWarmupEnabled | (internal) |
| 688 | fn | nextDailyRunDate | (private) |
| 699 | fn | restartWarmupScheduler | (private) |
| 732 | fn | runWarmupCycle | (private) |
| 795 | fn | warmupAccount | (private) |
| 840 | fn | warmupAccount | (private) |
| 901 | fn | fetchWarmupModels | (private) |
| 925 | fn | warmupAvailableModels | (internal) |
| 938 | fn | warmupAuthInfo | (private) |
| 960 | fn | warmupTargets | (private) |
| 974 | fn | updateWarmupStatus | (private) |
| 1003 | fn | startProxy | (internal) |
| 1047 | fn | stopProxy | (internal) |
| 1075 | fn | toggleProxy | (internal) |
| 1083 | fn | setupAPIClient | (private) |
| 1090 | fn | startAutoRefresh | (private) |
| 1127 | fn | attemptProxyRecovery | (private) |
| 1149 | fn | refreshData | (internal) |
| 1202 | fn | manualRefresh | (internal) |
| 1213 | fn | refreshAllQuotas | (internal) |
| 1253 | fn | refreshQuotasUnified | (internal) |
| 1287 | fn | refreshAntigravityQuotasInternal | (private) |
| 1307 | fn | refreshAntigravityQuotasWithoutDetect | (private) |
| 1324 | fn | isAntigravityAccountActive | (internal) |
| 1329 | fn | switchAntigravityAccount | (internal) |
| 1339 | fn | beginAntigravitySwitch | (internal) |
| 1344 | fn | cancelAntigravitySwitch | (internal) |
| 1349 | fn | dismissAntigravitySwitchResult | (internal) |
| 1352 | fn | refreshOpenAIQuotasInternal | (private) |
| 1357 | fn | refreshCopilotQuotasInternal | (private) |
| 1362 | fn | refreshQuotaForProvider | (internal) |
| 1397 | fn | refreshAutoDetectedProviders | (internal) |
| 1404 | fn | startOAuth | (internal) |
| 1449 | fn | startCopilotAuth | (private) |
| 1466 | fn | startKiroAuth | (private) |
| 1506 | fn | pollCopilotAuthCompletion | (private) |
| 1523 | fn | pollKiroAuthCompletion | (private) |
| 1546 | fn | pollOAuthStatus | (private) |
| 1574 | fn | cancelOAuth | (internal) |
| 1578 | fn | deleteAuthFile | (internal) |
| 1614 | fn | toggleAuthFileDisabled | (internal) |
| 1645 | fn | pruneMenuBarItems | (private) |
| 1681 | fn | importVertexServiceAccount | (internal) |
| 1705 | fn | fetchAPIKeys | (internal) |
| 1715 | fn | addAPIKey | (internal) |
| 1727 | fn | updateAPIKey | (internal) |
| 1739 | fn | deleteAPIKey | (internal) |
| 1752 | fn | checkAccountStatusChanges | (private) |
| 1773 | fn | checkQuotaNotifications | (internal) |
| 1805 | fn | scanIDEsWithConsent | (internal) |
| 1875 | fn | savePersistedIDEQuotas | (private) |
| 1898 | fn | loadPersistedIDEQuotas | (private) |
| 1960 | fn | shortenAccountKey | (private) |
| 1972 | struct | OAuthState | (internal) |
