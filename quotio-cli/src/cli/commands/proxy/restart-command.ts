...
import { restartProxy, getProcessState } from "../../../services/proxy-process/index.ts";
import { getBinaryInfo } from "../../../services/proxy-binary/index.ts";

export async function proxyRestart(port: number, ctx: CLIContext): Promise<CommandResult> {
  try {
