...
struct SwitchAccountSheet: View {
    ...
    private var switchState: AntigravitySwitchState {
        viewModel.snapshot.state
    }
    ...
    var body: some View {
        ...
        .frame(width: 380)
        .task {
            await viewModel.refreshIDERunningState()
        }
    }
    ...
    private func progressContent(progress: AntigravitySwitchProgress) -> some View {
        VStack(spacing: 16) {
            ProgressView()
                .scaleEffect(1.2)
    ...
    private func progressStep(_ step: AntigravitySwitchProgress, current: AntigravitySwitchProgress) -> some View {
    ...
    private func stepOrder(_ step: AntigravitySwitchProgress) -> Int {
        switch step {
    ...
    private func progressText(for progress: AntigravitySwitchProgress) -> String {
        switch progress {
