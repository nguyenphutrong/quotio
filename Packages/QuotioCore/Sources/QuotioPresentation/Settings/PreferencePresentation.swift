...
@MainActor
public extension OperatingMode {
...
public extension MenuBarQuotaItem {
    var aiProvider: QuotaProvider? {
...
public extension MenuBarColorMode {
    var localizationKey: String {
        switch self {
...
public extension QuotaDisplayMode {
    var localizationKey: String {
        switch self {
...
public extension QuotaDisplayStyle {
    var localizationKey: String {
        switch self {
...
public extension TotalUsageMode {
    var localizationKey: String {
        switch self {
...
public extension ModelAggregationMode {
    var localizationKey: String {
        switch self {
...
public extension WarmupCadence {
    var localizationKey: String {
        switch self {
...
public extension WarmupScheduleMode {
    var localizationKey: String {
        switch self {
...
public extension IDEScanOptions {
