...
public extension QuotaMetric {
    ...
    var displayName: String {
        ...
        case "opencodego-five-hour": "quota.metric.fiveHour".localizedStatic()
        case "opencodego-weekly": "quota.metric.weekly".localizedStatic()
        case "opencodego-monthly": "quota.metric.monthly".localizedStatic()
